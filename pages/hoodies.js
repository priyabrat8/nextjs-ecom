...
const Hoodies = ({ products }) => {
  return (
    <div className="bg-gray-100 min-h-screen">
      <Head>
        <title>Shop A Hoodie For You</title>
        <meta name="description" content="Best place to shop hoodies" />
        <link rel="icon" href="/ecommerce.png" />
      </Head>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
          {Object.keys(products).length === 0 && <p className="p-14 shadow-xl text-center text-red-600 font-bold">Sorry, Hoodies are currently out of stock.</p>}
...
export async function getServerSideProps(context) {
  ...
  return {
    props: { products: JSON.parse(JSON.stringify(hoodie)) },
  };
}
