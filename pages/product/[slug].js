        ...
        <>
                    ...
                    <div className="flex">
                      <span className="flex items-center">
                        ...
                        <span className="text-gray-600 ml-3">
                          {!(review.rating / review.numrating)
                            ? 0
                            : review.rating / review.numrating}{" "}
                          out of 5
                        </span>
          ...
          <div id="reviews" className="transition-opacity">
            <div className="flex justify-between">
              <h3 className="font-semibold text-3xl ml-9 mb-6 inline-block text-black">
                Reviews
              </h3>
              <button
                onClick={add}
                className="mb-3 disabled:bg-purple-300  ml-4 text-white bg-purple-500 border-0  px-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded mr-5"
              >
                ...
                <div className="py-10 bg-white rounded-lg p-8  shadow-md">
                  ...
                  <div className="flex items-center">
                    <svg
                      ...
                      name="1"
                      className={`w-10 h-10 ${
                        star >= 1 ? "text-yellow-400" : "text-gray-300"
                      } cursor-pointer `}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <svg
                      ...
                      name="2"
                      className={`w-10 h-10 ${
                        star >= 2 ? "text-yellow-400" : "text-gray-300"
                      } cursor-pointer `}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
           ...
           {comments.length === 0 &&  <div
            ...
            {comments.length !== 0 &&  comments.map((e) => {
              return (
                <div
                  key={e.email}
                  className="flex items-center pt-5 mx-8 bg-white mb-10 rounded-lg overflow-auto"
                >
                  <div className="ml-6">
                    ...
                    <div className="flex items-center mt-1">
                      <svg
                        className={`w-5 h-5 ${
                          e.rating >= 1 ? "text-yellow-400" : "text-gray-300"
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <svg
                        className={`w-5 h-5 ${
                          e.rating >= 2 ? "text-yellow-400" : "text-gray-300"
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <svg
                        className={`w-5 h-5 ${
                          e.rating >= 3 ? "text-yellow-400" : "text-gray-300"
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <svg
                        className={`w-5 h-5 ${
                          e.rating >= 4 ? "text-yellow-400" : "text-gray-300"
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <svg
                        className={`w-5 h-5 ${
                          e.rating >= 5 ? "text-yellow-400" : "text-gray-300"
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
